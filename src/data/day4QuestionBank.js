/** Day 4 — Averages: 25 MCQs + 5 Fill in the Blanks · 30 min */
export const DAY4_QUESTION_BANK = {
  ...
  questions: [
    ...
    { id: 6, type: 'mcq', question: 'The average salary of 12 employees is ₹25,000. If the manager\'s salary of ₹61,000 is excluded, find the average salary of the remaining employees.', options: ['₹21,727', '₹22,000', '₹23,000', '₹24,000'], answer: 0 },
    ...
    { id: 17, type: 'mcq', question: 'The average income of a family of six members is ₹32,000. One member leaves, reducing the average to ₹30,000. Find the income of the member who left.', options: ['₹40,000', '₹42,000', '₹44,000', '₹46,000'], answer: 1 },
...
export const DAY4_DURATION_SECONDS = 30 * 60;
export const DAY4_TOTAL_QUESTIONS = 30;
